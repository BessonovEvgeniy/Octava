...
INSERT INTO USERS (id, name, login, role_id, password, enabled) VALUES (1, 'ADMIN', 'admin', 1, '$2a$04$L5JtzYADN0v1Yi8Kou29zeRi52gJ4BnZjJNZ32P5KV3PyZ7pCxSGm', '1'); -- Use 'admin' as a password. Password encrypted by BCrypt
